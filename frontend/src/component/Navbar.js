...
import headerImg from '../img/jobguild.png';
import '../App.css';
        ...
        <AppBar position="static" sx={{ bgcolor: palette.primary.main }}>
            <Container >
                ...
                <Toolbar disableGutters>
                    ...
                    {/* <img src={headerImage} alt="Header Image" sx={{ display: { xs: 'none', md: 'flex' }, mr: 1 }} /> */}
                    <Typography
                        variant="h6"
                        noWrap
                        component="a"
                    ...
                    >
                        {/* JOB PORTAL */}
                        <img src={headerImg} alt="Header Image" sx={{ display: { xs: 'none', md: 'flex' }, mr: 1 }} />   
                    </Typography>
